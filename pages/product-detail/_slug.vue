<template>
    <div>
        <div class="bg-softGray" v-if="($nuxt.$route.path === '/product-detail/leather-jacket') || ($nuxt.$route.path === '/product-detail/purple-hoodie')">
            ...
            <nuxt-link to="/cart" class="bg-white rounded-full h-10 w-10 flex items-center justify-center">
            ...
            products: [
                {
                    ...
                    priceSlug: "price_1KuEIWHJDn8ciA9GMXhZfiln",
                    slug: "leather-jacket",
                ...
                },
                {
                    ...
                    priceSlug: "price_1Ku42cHJDn8ciA9GbEwhrJEm",
                    slug: "purple-hoodie",
